...
from dfastbe.bank_erosion.data_models import ParametersPerBank
...
class Debugger:
    ...
    def debug_process_discharge_levels_1(
        self, bank_index, bank_data, fairway_data, erosion_inputs, discharge_level_pars: ParametersPerBank,
        water_depth_fairway, dn_eq1, dv_eq1, bank_coords, bank_height, segment_length
    ):
        ...
        params = {
            "chainage": bank_data.bank_chainage_midpoints[bank_index],
            ...
            "bank_fairway_dist": bank_data.fairway_distances[bank_index],
    ...
    def debug_process_discharge_levels_2(
        self, ib, iq, bank_data, fairway_data, erosion_inputs, discharge_level_pars: ParametersPerBank,
        water_depth_fairway, bank_coords, velocity, bank_height, segment_length, water_level, chezy, dniqib, dviqib,
        erosion_distance_shipping, erosion_distance_flow
    ):
        bank_coords_mind = (bank_coords[:-1] + bank_coords[1:]) / 2

        bank_coords_points = [Point(xy1) for xy1 in bank_coords_mind]
