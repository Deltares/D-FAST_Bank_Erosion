...
The bottom level of the range of influence for equilibrium erosion is determined as the maximum of twice
the initial wave height at the toe of the foreshore ($H_0$) below the reference water level
($z_\text{w}(Q_\text{ref})$) and the level up to where the stone protection stays in place ($z_\text{prot}$):
\begin{equation}
