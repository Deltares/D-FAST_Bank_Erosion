...
& \keyw{EroVolEqui} & Name of file in which the equilibrium eroded volume per river-km is stored (default: 'erovol\_eq.evo') \\
...
The following excerpt of the default \keyw{messages.UK.ini} dialog text file shows the string definition
for 3 identifiers, namely \keyw{''} (the identifier for an empty line), \keyw{'header\_banklines'} and
\keyw{'end\_banklines'}.
...
=====================================================
version: D-FAST Bank Erosion {version}
source: {location}
[end_banklines]
