...
\dfastbe is compatible with \dhydrosuite 2025.02 (or higher).
...
This release modernises the graphical user interface and broadens platform support, while continuing the maintainability improvements released in version 3.0.0.
