...
class TestErosion:
    ...
    def test_run(
        ...
        mock_erosion.river_data.process_river_axis_by_center_line.return_value = (
            center_line_mock
        )
        with (
            patch(
                "dfastbe.bank_erosion.bank_erosion.MeshProcessor.get_fairway_data",
                return_value=mock_fairway_data,
            ) as mock_get_fairway_data,
            patch(
                "dfastbe.bank_erosion.bank_erosion.MeshProcessor.get_bank_data",
